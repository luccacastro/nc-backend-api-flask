from .controllers.Post import getPostSamples, getPostData, createPost
from .controllers.Comments import PostComments
from .controllers.User import getSingleUser
from .controllers.Subpage import SubPageData, getAllSubPages
from .controllers.Voting import changeContentScore
...
api.add_resource(getSingleUser, '/api/username/<string:name>', )
